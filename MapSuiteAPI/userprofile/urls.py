...
urlpatterns = [
    ...
    path('users/<int:pk>', views.RetreiveUser.as_view(), name='one-user'), # done testing
    path('annotations/<int:pk>', views.RetreiveAnnotation.as_view(), name='one-annotation'), # done testing
    ...
    path('users',views.getAllUsers.as_view(), name='all-users'), # done testing
    path('annotations', views.getAllAnnotations.as_view(), name='all-annotations'), # done testing
    path('username=<str:username>/annotations=<str:keyword>', views.getSingleUserAnnotation.as_view(), name='user-singleannotation'),
    path('username=<str:username>/home',views.getUserHomes.as_view(), name='user-homes'),
